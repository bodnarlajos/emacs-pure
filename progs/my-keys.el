...
(global-set-key (kbd "C-c m j") 'windmove-swap-states-up)
(global-set-key (kbd "C-c m k") 'windmove-swap-states-down)
(global-set-key (kbd "C-c g h") 'windmove-left)
(global-set-key (kbd "C-c g l") 'windmove-right)
(global-set-key (kbd "C-c g j") 'windmove-up)
(global-set-key (kbd "C-c g k") 'windmove-down)
(global-set-key (kbd "C-c k h") 'windmove-delete-left)
(global-set-key (kbd "C-c k l") 'windmove-delete-right)
(global-set-key (kbd "C-c k j") 'windmove-delete-up)
(global-set-key (kbd "C-c k k") 'windmove-delete-down)
(global-set-key (kbd "C-c s j") 'split-window-vertically)
(global-set-key (kbd "C-c s k") 'split-window-horizontally)
