...
(global-set-key (kbd "C-c m k") 'windmove-swap-states-right)
(global-set-key (kbd "C-c m u") 'windmove-swap-states-up)
(global-set-key (kbd "C-c m j") 'windmove-swap-states-down)
(global-set-key (kbd "C-c g h") 'windmove-left)
(global-set-key (kbd "C-c g k") 'windmove-right)
(global-set-key (kbd "C-c g u") 'windmove-up)
(global-set-key (kbd "C-c g j") 'windmove-down)
(global-set-key (kbd "C-c k h") 'windmove-delete-left)
(global-set-key (kbd "C-c k k") 'windmove-delete-right)
(global-set-key (kbd "C-c k u") 'windmove-delete-up)
(global-set-key (kbd "C-c k j") 'windmove-delete-down)
