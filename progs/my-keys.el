...
(define-key my-prefix (kbd "s j") 'split-window-vertically)
(define-key my-prefix (kbd "s k") 'split-window-horizontally)
...
(define-key my-prefix (kbd "v") 'my/xah-select-line)
