...
(with-eval-after-load 'org
  ...
  (defvar org-right-popup-menu
    (let ((menu (make-sparse-keymap "Org Commands")))
      ...
      (define-key menu [my/select-all] (cons "Select all" 'my/select-all))
      ...
      (define-key menu [centaur-tabs--create-new-empty-buffer] (cons "New buffer" 'centaur-tabs--create-new-empty-buffer))
