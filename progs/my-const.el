...
(defcustom my/menu-items '(("IDE" . my/run/bloated-hook) ("My-config" . my/open/my-config) ("Open desktop" . my/open/desktop) ("ReActivate My-config" . ignore) ("*Scratch*" . my/open/scratch) ("Notes" . my/open-notes) ("Git" . my/goto-magit) ("Files" . project-find-file) ("Ripgrep" . rg) ("Open file" . find-file)) "My-config menu items" :type '(alist :key-type string :value-type function) :group 'my/configs)
