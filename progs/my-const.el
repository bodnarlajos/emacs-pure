...
(defcustom my/menu-items '(("IDE" . my/run/bloated-hook) ("My-config" . my/open/my-config) ("Open desktop" . my/open/desktop) ("*Scratch*" . (switch-to-buffer "*scratch*")) ("Notes" . my/open-notes) ("VC" . vc-dir) ("Git" . my/goto-magit) ("Files" . project-find-file) ("Ripgrep" . rg) ("Open file" . find-file) ("Buffers" . consult-buffer)) "My-config menu items" :type '(alist :key-type string :value-type function) :group 'my/configs)
