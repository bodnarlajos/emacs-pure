...
(defun my/menu-base ()
	...
	(let ((replaceString "Replace string")
		...
		(let ((ido-list (list recentfFiles runCommand revertBuffer rg rgCurrent backTo development openNotes magit replaceString jumpTo flymakeList projectFindFile elScrn elScrnNext)))
